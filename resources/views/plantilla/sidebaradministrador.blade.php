    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li @click="menu=2" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-tasks"></i> Alertas</a>
            </li>
            <li @click="menu=3" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-shopping-cart"></i> Tiendas</a>
            </li>
            <li @click="menu=4" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-car"></i> Transporte</a>
            </li>
            <li @click="menu=5" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-suitcase"></i> Envios</a>
            </li>
