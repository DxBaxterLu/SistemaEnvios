                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" @keyup.enter="listarCategoria(1,buscar,criterio);" v-model="buscar" class="form-control" placeholder="Buscar Categoria">
                        ...
                        <tbody>
                            <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                ...
                                <td>
                                    ...
                                    <template v-else>
                                        <button type="button" class="btn btn-succes btn-sm" @click="activarCategoria(categoria.id);">
                ...
                reverseButtons: true
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.put('/categoria/desactivar',{
                            ...
                            swalWithBootstrapButtons.fire(
                            'Desactivado!',
                            'La categoria se a desactivado con exito!',
                            'success'
                            )
                        })
                        .catch(function (error) {
                ...
                reverseButtons: true
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.put('/categoria/activar',{
                            ...
                            swalWithBootstrapButtons.fire(
                            'Activado!',
                            'La categoria se activado con exito!',
                            'success'
                            )
                        })
                        .catch(function (error) {
